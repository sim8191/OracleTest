/*
    DCL(DATA CONTROL LANGUAGE)
     - 데이터 제어 언어
     - 계정의 시스템권한 혹은 객체접근 권한을 부여하거나 회수하는 언어
...
-- 3-1. SAMPLE 계정에 테이블 생성권한 부여(CREATE TABLE)
GRANT CREATE TABLE TO SAMPLE;

-- 3-2. SAMPLE 계정에 테이블스페이스할당(2MEGA BYTE)
-- ALTER문
ALTER USER SAMPLE QUOTA 2M ON SYSTEM;
-- 시스템의 저장공간 중 2M를 SAMPLE에게 나눠줌
