...
SELECT EMP_NAME, (SALARY * 12) AS "연봉", (SALARY+SALARY*BONUS)*12 "총수령액(보너스포함)", 
...
SELECT *
FROM EMPLOYEE
WHERE 4000000 <= SALARY  AND JOB_CODE = 'J2';

--10. EMPLOYEE테이블에 DEPT_CODE가 D9이거나 D5인 사원 중  
--고용일이 02년 1월 1일보다 빠른 사원의 이름, 부서코드, 고용일 조회
SELECT EMP_NAME, job_code, HIRE_DATE
FROM EMPLOYEE
--WHERE (DEPT_CODE = 'D9' OR DEPT_CODE = 'D9') AND HIRE_DATE <= '02/01/01';
...
--DB시험에서 위의 문제를 보여주고 틀린거 찾기 문제 나옴
