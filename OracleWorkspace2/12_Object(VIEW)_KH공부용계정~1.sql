...
/* 
    ...
    * 뷰를 통해 DML이 불가능한 경우 
    ...
    2) 뷰에 정의되어 있지 않은 칼럼 중 NOT NULL제약조건이 추가된 칼럼이 존재하는 경우
...
*/
-- 1) 뷰에 정의되지 않은 칼럼을 조작
-- 2) 뷰에 정의되어 있지 않은 칼럼 중, 원본테이블상에 NOT NULL제약조건이 추가된 경우.
CREATE OR REPLACE VIEW VW_JOB 
AS SELECT JOB_NAME FROM JOB;

INSERT INTO VW_JOB(JOB_CODE, JOB_NAME) VALUES ('J9','인턴'); -- 실패
