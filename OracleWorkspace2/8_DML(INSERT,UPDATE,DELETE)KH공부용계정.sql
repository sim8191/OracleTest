...
/* 
    * INSERT ALL 계열
     - 두 개 이상의 테이블에 각각 INSERT할 때 사용하는 쿼리문
...
-- EMP_SALARY테이블에서 노옹철 사워읜 월급을 1000만원으로변경
UPDATE EMP_SALARY
SET SALARY = 10000000
WHERE EMP_NAME = '노옹철';
...
/* 
    ...
    WHERE 조건식;
*/
-- EMP_SALAY테이블에 박말똥 사원의 부서코드를 선동일 사원의 부서코드로 변경
SELECT * FROM EMP_SALARY;
...
-- DEPARTMENT테이블에 DEPT_ID가 D1인 부서 삭제하기.
