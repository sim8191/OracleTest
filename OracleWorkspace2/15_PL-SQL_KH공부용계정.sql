...
BEGIN
    ...
    SELECT *
     ...
     DNAME := CASE EMP.DEPT_CODE
                   ...
                   ELSE '해외영업팀' 
              END;
    DBMS_OUTPUT.PUT_LINE(EMP.EMP_NAME || '은' || DNAME ||'에서 근무하고 있습니다.');
END;
/
----------------------------------------------------------------------------
/* 
...
BEGIN
    ...
    IF EMP.BONUS IS NULL
        THEN SAL := EMP.SALARY * 12;
    ELSE SAL := (EMP.SALARY + EMP.SALARY * EMP.BONUS ) * 12;
    END IF; 
...
BEGIN
    ...
    WHERE EMP_NAME = '노옹철';
EXCEPTION
    WHEN DUP_VAL_ON_INDEX THEN DBMS_OUTPUT.PUT_LINE('중복된사번입니다.');
END;
/
